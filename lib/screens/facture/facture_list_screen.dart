  ...
  Future<void> _openDetail(FactureListItem item) async {
    ...
    final changed = await Navigator.of(context).push<bool>(MaterialPageRoute(
      builder: (_) => FactureDetailScreen(
        ...
        mode: widget.mode,
        user: widget.user,
        personnesId: item.personnesId,
        clientNom: item.personnesId != null ? item.nomComplet : item.nomVisiteur,
        clientPrenom: item.personnesId != null ? item.prenomPersonnes : item.prenomVisiteur,
        clientTelephone: item.contactAffiche == '-' ? null : item.contactAffiche,
        clientCin: item.cinPersonnes,
